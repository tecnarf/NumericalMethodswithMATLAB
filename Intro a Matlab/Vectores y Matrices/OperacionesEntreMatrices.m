...
div_elem_der=Matriz1./Matriz2;%Division por la derecha (barra inclinada hacia la derecha)
div_elem_izq=Matriz1.\Matriz2;%Division por la izquierda (barra inclinada hacia la izquierda)